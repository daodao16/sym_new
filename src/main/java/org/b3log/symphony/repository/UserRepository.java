...
public class UserRepository extends AbstractRepository {
    ...
    /**
     * Gets a user by the specified mobile.
     *
     * @param mobile the specified email
     * @return user, returns {@code null} if not found
     * @throws RepositoryException repository exception
     */
	public JSONObject getByMobile(String mobile) throws RepositoryException {
		final Query query = new Query().setPageCount(1);
        query.setFilter(new PropertyFilter(UserExt.USER_MOBOLE, FilterOperator.EQUAL, mobile.trim()));
