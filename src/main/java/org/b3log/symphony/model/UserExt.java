...
public final class UserExt {
	...
	/**
     * Key of user mobile(add by daodao at 20190125).
     */
    public static final String USER_MOBOLE = "userMobile";
    
    /**
     * Key of user mobile vertify code(add by daodao at 20190125).
     */
    public static final String USER_MOBOLE_V_CODE = "userMobileVCode";
