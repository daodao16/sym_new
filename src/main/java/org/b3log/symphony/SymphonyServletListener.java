...
import org.b3log.symphony.service.JobQueryService;
...
public final class SymphonyServletListener extends AbstractServletListener {
    ...
    public void contextInitialized(final ServletContextEvent servletContextEvent) {
        ...
        //add by daodao at 20190202 初始化职位信息
        JobQueryService jobQueryService = beanManager.getReference(JobQueryService.class);
        jobQueryService.initJobs();
