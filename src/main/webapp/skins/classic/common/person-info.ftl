        ...
        <div class="fn-clear">
            ...
            <div class="fn-right">
                ...
                <a href="${servePath}/member/${currentUser.userName}/points" class="tooltipped tooltipped-w ft-fade"
                   ...
                   ${currentUser.userPoint?c}
                    <#--<#if 0 == currentUser.userAppRole>0x${currentUser.userPointHex}<#else><div class="painter-point" style="background-color: #${currentUser.userPointCC}"></div></#if>-->
                </a>
            </div>
        </div>
    </div> 
