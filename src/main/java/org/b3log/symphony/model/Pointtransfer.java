...
public final class Pointtransfer {
    ...
    /**
     * Transfer type - Finish guide Income.
     */
    public static final int TRANSFER_TYPE_C_FIN_GUIDE = 103;

    /**
     * Transfer sum - Finish guide.
     */
    public static final int TRANSFER_SUM_C_FIN_GUIDE = Symphonys.getInt("pointFinishGuide");
    ...
    /**
     * Transfer sum - Add Article Anonymous.
     */
    public static final int TRANSFER_SUM_C_ADD_ARTICLE_ANONYMOUS = Symphonys.getInt("anonymous.point");
    ...
    /**
     * Transfer sum - Be Invited Register.
     */
    public static final int TRANSFER_SUM_C_BE_INVITE_REGISTER = Symphonys.getInt("pointBeInviteRegister");
    ...
    /**
     * Transfer type - Add Article Q&A Outcome.
     */
    public static final int TRANSFER_TYPE_C_ADD_ARTICLE_QNA = 101;

    /**
     * Transfer sum - Add Article.
     */
    public static final int TRANSFER_SUM_C_ADD_ARTICLE_QNA = Symphonys.getInt("pointAddArticleQna");
    
    /**
     * Transfer type - Add Article discuss Outcome.
     */
    public static final int TRANSFER_TYPE_C_ADD_ARTICLE_DISCUSS = 102;

    /**
     * Transfer sum - Add Article.
     */
    public static final int TRANSFER_SUM_C_ADD_ARTICLE_DISCUSS = Symphonys.getInt("pointAddArticleDisscuss");
    
    /**
     * Transfer type - Add Article contains reserved tags.
     */
    public static final int TRANSFER_TYPE_C_ADD_ARTICLE_TAG = 104;
    ...
    /**
     * Transfer sum - Article be Thanked.
     */
    public static final int TRANSFER_SUM_C_ARTICLE_BE_THANK = Symphonys.getInt("pointBeThankArticle");
