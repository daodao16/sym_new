...
<html>
    ...
    <body>
                ...
                <div class="verify-wrap">
                    <div class="form">
                        ...
                        <div class="input-wrap">
                            ...
                            <input id="registerUserMobile" type="text" placeholder="${mobilePlaceholderLabel}" autocomplete="off" />
                        </div>
                        ...
                        <div class="input-wrap<#--#if "2" == miscAllowRegister> fn-none</#if-->">
                            ...
                            <button id="vertifyMobileBtn" onclick="Verify.sendMobileVCode($('#registerUserMobile'),$('#registerTip'),$('#vertifyMobileBtn'),$('#registerCaptcha'),$('#registerCaptchaImg'),0)">${sendMobileVCodeLabel}</button>
                        </div>
                        
                        <div class="input-wrap">
                        	<svg><use xlink:href="#email"></use></svg>
                            <input id="registerVCode" type="text" placeholder="${mobileVCodePlaceholderLabel}" autocomplete="off" />
                        </div>
        ...
        <script>
            ...
            Label.invalidUserMobileLabel = "${invalidUserMobileLabel}";
            Label.invalidVCodeLabel = "${invalidVCodeLabel}";
            Label.resendMobileVCodeLabel = "${resendMobileVCodeLabel}";
            Label.forbidMobileVCodeLabel = "${forbidMobileVCodeLabel}";
        </script>
    </body>
</html>
