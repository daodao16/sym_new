                ...
                <div class="verify-wrap">
                    <div class="form">
						...
						<div class="input-wrap">
                            ...
                            <input id="fpwdUserMobile" type="text" placeholder="${mobileLabel}" autocomplete="off" />
                        </div>
                        <div class="input-wrap">
                            ...
                            <button id="vertifyMobileBtn" onclick="Verify.sendMobileVCode($('#fpwdUserMobile'),$('#fpwdTip'),$('#vertifyMobileBtn'),$('#fpwdSecurityCode'),$('#fpwdCaptcha'),1)">${sendMobileVCodeLabel}</button>
                        </div>
                        <div class="input-wrap">
                        	<svg><use xlink:href="#email"></use></svg>
                            <input id="fpwdVCode" type="text" placeholder="${mobileVCodePlaceholderLabel}" autocomplete="off" />
                        </div>
