...
public class InitMgmtService {
    ...
    public void initSym() {
        ...
        try {
            ...
            //add by daodao at 20190128 mock mobile
            admin.put(UserExt.USER_MOBOLE, "1234567890");
            ...
            //add by daodao at 20190128 mock mobile
            comBot.put(UserExt.USER_MOBOLE, "1234567891");
            ...
            article.put(Article.ARTICLE_TITLE, "欢迎加入「loseRUNion」！ :gift_heart:");
            article.put(Article.ARTICLE_TAGS, "Sym,Announcement");
            article.put(Article.ARTICLE_CONTENT, 
            		"<p>这里是离职者、失业者的联盟社区，邀你共同度过一段特殊的时光。</p><p>「loseRUNion」原为loser union，union的成立是为了我们能互相鼓励和温暖，一个特定时点的无力感并不能贯穿人生始终，我们相信一切都是最好的安排。给自己一段时间沉淀，给自己一个机会成就未来。</p><p>失业而不失序，「RUN」源自我们从未止步的灵魂。</p>");
