...
<html>
    <head>
		...
		<link rel="stylesheet" href="${staticServePath}/css/jquery-ui.min.css">
        <style>
    ...
    <body>
                ...
                <div class="verify-wrap">
                    <div class="form">
                        ...
                        <div class="input-wrap">
                            ...
                            <svg><use xlink:href="#job"></use></svg>
							<input type="text" id="jobDesc" placeholder="${jobDescLabel}"/>
                        </div>
                        <div class="input-wrap">
        ...
        <script src="${staticServePath}/js/lib/jquery/jquery-ui.min.js"></script>
        <script>
            Verify.init();
            //Verify.initMobile();
            Verify.initJob();
